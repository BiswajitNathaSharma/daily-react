...
function App() {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row">
      <div className="bg-[#172842] lg:min-h-screen py-8 flex-grow rounded-xl">
    ...
    <p className='text-red-800'> * I am sorry, if you are seeing offensive content in image. It is generated by inspirobot API.</p>
